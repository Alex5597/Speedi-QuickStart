...
public class Chassis implements Module {
    ...
    public Chassis(HardwareMap hardwareMap, boolean brake) {
        ...
        LFM = new CoolMotor(hardwareMap.get(DcMotorEx.class, "LFM"), "left front motor");
        LBM = new CoolMotor(hardwareMap.get(DcMotorEx.class, "LBM"), "left back motor");
        RFM = new CoolMotor(hardwareMap.get(DcMotorEx.class, "RFM"), "right front motor");
        RBM = new CoolMotor(hardwareMap.get(DcMotorEx.class, "RBM"), "right back motor");
        if (brake) {
