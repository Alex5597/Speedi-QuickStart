...
public class Encoder {
    ...
    private double inverseOverflow(double input, double estimate) {
        // convert to uint16
    ...
    public Encoder(DcMotorEx motor, NanoClock clock, int lastEncTicks) {
        this.motor = motor;
        this.clock = clock;

        this.direction = Direction.FORWARD;

        this.lastEncTicks = lastEncTicks;
        this.lastPosition = 0;
        this.velocityEstimates = new double[3];
        this.lastUpdateTime = clock.seconds();
    }
    ...
    public Encoder(DcMotorEx motor, int lastEncTicks) {
        this(motor, NanoClock.system(), lastEncTicks);
    }
    ...
    public double getCurrentPosition() {
        ...
        int currentPosition = motor.getCurrentPosition() * multiplier - lastEncTicks;
